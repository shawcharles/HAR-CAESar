...
This library implements the models developed for the MSc Thesis: *"Forecasting Tail Risk with Long-Memory: A Heterogeneous Extension of the CAESar Model"*. The full thesis is available at `thesis.pdf <../thesis.pdf>`_.
